...
sub annotateMutation{
    ...
    if($children_pids[1] == 0){
        ...
        if(-s $snpFile){
	    # use yunfei's new query function instead
#	    print ("/ssd/icages-humandb/genomeLocusFinder.pl find /ssd/icages-humandb/" . $hg . "_iCAGES.txt $snpFile iCAGES $snpFile." . $hg . "_iCAGES_dropped");

#	    !system("/ssd/icages-humandb/genomeLocusFinder.pl find /ssd/icages-humandb/" . $hg . "_iCAGES.txt $snpFile iCAGES $snpFile." . $hg . "_iCAGES_dropped") or die "ERROR: cannot call icages\n";
	    !system("$icagesLocation/genomeLocusFinder.pl find $DBLocation" . $hg . "_iCAGES.txt $snpFile iCAGES $snpFile." . $hg . "_iCAGES_dropped") or die "ERROR: cannot call icages\n";
	...
	if(-s $snpFile){
	    # use yunfei's new query function instead
#	    print ("/ssd/icages-humandb/genomeLocusFinder.pl find /ssd/icages-humandb/" . $hg . "_funseq2.txt $snpFile funseq2 $snpFile." . $hg . "_funseq2_dropped\n");
#	    !system("/ssd/icages-humandb/genomeLocusFinder.pl find /ssd/icages-humandb/" . $hg . "_funseq2.txt $snpFile funseq2 $snpFile." . $hg . "_funseq2_dropped") or die "ERROR: cannot call funseq2\n";
	    
	    !system("$icagesLocation/genomeLocusFinder.pl find $DBLocation" . $hg . "_funseq2.txt $snpFile funseq2 $snpFile." . $hg . "_funseq2_dropped") or die "ERROR: cannot call funseq2\n";
