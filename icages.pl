...
my ($inputFile, $inputDir, $icagesLocation, $tumor, $germline, $id, $subtype , $logDir, $outputDir, $tempDir, $prefix, $bed, $hg19, $expression);
...
sub processArguments {
    my ($help, $manual, $tumor, $germline, $id, $subtype, $logDir, $outputDir, $tempDir, $prefix, $inputDir, $inputLocation, $icagesLocation, $bed, $expression, $hg);
    ...
    return ($inputDir, $icagesLocation, $tumor, $germline, $id, $subtype , $logDir, $outputDir, $tempDir, $prefix, $bed, $hg, $expression);
}
...
=head1 SYNOPSIS
 ...
 Options:                                                                                                                                                                                                                                                                     
        ...
        -e, --expression                bed file describing gene expression patterns, the columns are chromosome, start, end, log fold changes
