...
my ($inputFile, $inputDir, $icagesLocation, $tumor, $germline, $id, $subtype , $logDir, $outputDir, $tempDir, $prefix, $bed);

######################################################################################################################################
############################################################# main  ##################################################################
######################################################################################################################################
($inputDir, $icagesLocation, $tumor, $germline, $id, $subtype , $logDir, $outputDir, $tempDir, $prefix, $bed) =  &processArguments();
...
$inputFile = $ARGV[0];
!system("perl $icagesMutation $inputFile $inputDir $icagesLocation $tumor $germline $id $prefix $bed") or die "ERROR: cannot call icagesMutation module\n";
...
sub processArguments {
    my ($help, $manual, $tumor, $germline, $id, $subtype, $logDir, $outputDir, $tempDir, $prefix, $inputDir, $inputLocation, $icagesLocation, $bed);
    ...
    return ($inputDir, $icagesLocation, $tumor, $germline, $id, $subtype , $logDir, $outputDir, $tempDir, $prefix, $bed);
}
